...
class MainPage(BasePage):
    ...
    @allure.step(f"Переход на главную страницу {url_main}")
    ...
    @allure.step("Нажатие на вопрос и получение ответа")
    ...
    @allure.step('Скролл до кнопки "Заказать" и нажатие кнопки "Заказать"')
