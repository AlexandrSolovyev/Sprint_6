...
class TestOrderPage:
    ...
    @pytest.mark.parametrize(
        'name, second_name, address, locator_station, date, color_locator, time_locator',
        [
            (
                DataOrderForm.name,
                DataOrderForm.second_name,
                DataOrderForm.address,
    ...
    def test_order_form(
        ...
        order_page.set_text_to_first_form(
            OrderPageLocators.NAME_REG_LOCATOR,
            name,
            OrderPageLocators.SECOND_NAME_REG_LOCATOR,
            second_name,
            OrderPageLocators.ADDRESS_REG_LOCATOR,
            address,
            OrderPageLocators.PHON_NUM_REG_LOCATOR,
            number
        )
        ...
        result = order_page.click_on_order_and_get_text_notification(
    ...
    def test_jump_main_page(self, driver):
        order_page = OrderPage(driver)
        order_page.go_to_url_order()
